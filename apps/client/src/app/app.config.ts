...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideIcons({
      lucideGithub, lucideLinkedin, lucideArrowRight, lucideStars, lucideLoader2, lucideStar, lucideGitFork, lucideExternalLink, lucideFolder, lucideTag, lucideInfo, lucideCamera, lucideMenu, lucideX, lucidePalette, lucideMail, lucideChevronUp, lucideChevronDown, lucideCalendar, lucideFileText, lucidePhone, lucideTerminal,
